...
abstract class $TagCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int stationcount});
}
...
class _$TagImpl implements _Tag {
  _$TagImpl({required this.name, required this.stationcount});
...
abstract class _Tag implements Tag {
  factory _Tag({required final String name, required final int stationcount}) =
      _$TagImpl;
